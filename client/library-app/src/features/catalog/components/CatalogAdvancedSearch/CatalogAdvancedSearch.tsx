        ...
        <div className="catalog-advanced-search">
            ...
            <form className="catalog-advanced-search-form">
                <div className="catalog-advanced-search-form-input-group">
                    <p>ISBN</p>
                    <input id="isbn" className="catalog-advanced-search-form-input" placeholder={"ISBN"} ref={isbnRef} />
                </div>
                <div className="catalog-advanced-search-form-input-group">
                    <p>Title</p>
                    <input id="title" className="catalog-advanced-search-form-input" placeholder={"Title"} ref={titleRef} />
                </div>
                <div className="catalog-advanced-search-form-input-group">
                    <p>Author</p>
                    <input id="author" className="catalog-advanced-search-form-input" placeholder={"Author"} ref={authorRef} />
                </div>
                <div className="catalog-advanced-search-form-input-group">
                    <p>Description</p>
                    <input id="description" className="catalog-advanced-search-form-input" placeholder={"Description"} ref={descriptionRef} />
                </div>
                <div className="catalog-advanced-search-form-input-group">
                    <p>Subject</p>
                    <input id="subject" className="catalog-advanced-search-form-input" placeholder={"Subject"} ref={subjectRef} />
                </div>
                <div className="catalog-advanced-search-form-input-group">
                    <p>Genre</p>
                    <input id="genre" className="catalog-advanced-search-form-input" placeholder={"Genre"} ref={genreRef} />
                </div>
            </form>
